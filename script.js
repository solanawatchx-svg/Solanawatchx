        ...
        card.innerHTML = `
            <div class="flex flex-col space-y-2">
                <div class="flex items-start justify-between">
                    <div class="flex items-center space-x-3 overflow-hidden">
                        ...
                        <div class="flex flex-col overflow-hidden">
                            <p class="font-bold text-white truncate text-sm">${token.name}</p>
                ...
                <div class="flex items-center justify-between pl-12">
                    ...
                    <div class="flex space-x-3 text-xs text-right">
                ...
                <div class="insight-content hidden mt-2 p-3 bg-gray-900/50 rounded text-sm text-purple-300 italic"></div>
            </div>
        `;
